...
namespace Bookify.Infrastructure.Data.Migrations
{
    ...
    [Migration("20240423125019_Create_Database")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bookify.Domain.Features.Apartments.Apartment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Bookify.Domain.Features.Bookings.Booking", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Bookify.Domain.Features.Users.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Bookify.Domain.Features.Apartments.Apartment", b =>
                {
                    b.OwnsOne("Bookify.Domain.Features.Apartments.Address", "Address", b1 =>
                        {
            ...
            modelBuilder.Entity("Bookify.Domain.Features.Bookings.Booking", b =>
                {
                    b.HasOne("Bookify.Domain.Features.Apartments.Apartment", null)
                        .WithMany()
                        .HasForeignKey("ApartmentId")
                    ...
                    b.HasOne("Bookify.Domain.Features.Users.User", null)
                        .WithMany()
                    ...
                    b.OwnsOne("Bookify.Domain.Features.Bookings.DateRange", "Duration", b1 =>
                        {
                            b1.Property<Guid>("BookingId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
